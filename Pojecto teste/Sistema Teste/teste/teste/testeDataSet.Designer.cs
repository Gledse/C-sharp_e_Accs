...
namespace teste {
    ...
    public partial class testeDataSet : global::System.Data.DataSet {
        ...
        public partial class testeDataTable : global::System.Data.TypedTableBase<testeRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public testeRow FindBycodigo(int codigo) {
...
namespace teste.testeDataSetTableAdapters {
    ...
    public partial class testeTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `teste` WHERE ((`codigo` = ?) AND ((? = 1 AND `nome` IS NULL) OR (`no" +
                "me` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `teste` (`nome`) VALUES (?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `teste` SET `nome` = ? WHERE ((`codigo` = ?) AND ((? = 1 AND `nome` IS NUL" +
                "L) OR (`nome` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::teste.Properties.Settings.Default.testeConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT codigo, nome FROM teste";
        ...
        public virtual int UpdateAll(testeDataSet dataSet) {
            ...
            try {
                ...
                if ((this._testeTableAdapter != null)) {
                    ...
                    this._testeTableAdapter.Connection = ((global::System.Data.OleDb.OleDbConnection)(workConnection));
                    this._testeTableAdapter.Transaction = ((global::System.Data.OleDb.OleDbTransaction)(workTransaction));
                ...
                if ((this._testeTableAdapter != null)) {
                    this._testeTableAdapter.Connection = ((global::System.Data.OleDb.OleDbConnection)(revertConnections[this._testeTableAdapter]));
